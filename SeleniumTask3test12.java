...
import POM.Erlogin;
import POM.SeleniumTask3tc12;
import POM.SeleniumTask3tc5;
import Utility.Parametrerization;

public class SeleniumTask3test12 {
	WebDriver driver;
	@BeforeMethod
...
//		 erlogin.Enterpass("Chava*4999+2022",driver);
		 erlogin.Clickonlogin();
		 SeleniumTask3tc12 seleniumtask3tc12=new SeleniumTask3tc12(driver);
		 seleniumtask3tc12.clickonworkflow(driver);
		 seleniumtask3tc12.clickonplusicon(driver);
		 seleniumtask3tc12.clickonplusicon2(driver);
