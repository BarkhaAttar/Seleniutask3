...
import POM.Erlogin;
import POM.SeleniumTask3tc14;
import POM.SeleniumTask3tc7;
import Utility.Parametrerization;

public class SeleniumTask3test14 {
	WebDriver driver;
	@BeforeMethod
...
//		 erlogin.Enterpass("Chava*4999+2022",driver);
		 erlogin.Clickonlogin();
		 SeleniumTask3tc14 seleniumtask3tc14=new SeleniumTask3tc14(driver);
		 seleniumtask3tc14.clickonworkflow(driver);
		 seleniumtask3tc14.clickonplusicon(driver);
		 seleniumtask3tc14.clickonplusicon2(driver);
